      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img
            ...
            alt=""
            @click="
              $router.push({ path: '/movie_detail', query: { movie_id: 5 } })
            "
          />
        </div>
        <div class="swiper-slide">
          <img
            ...
            alt=""
            @click="
              $router.push({ path: '/movie_detail', query: { movie_id: 3 } })
            "
          />
        </div>
        <div class="swiper-slide">
          <img
            ...
            alt=""
            @click="
              $router.push({ path: '/movie_detail', query: { movie_id: 34 } })
            "
          />
        </div>
        <div class="swiper-slide">
          <img
            ...
            alt=""
            @click="
              $router.push({ path: '/movie_detail', query: { movie_id: 4 } })
            "
          />
        </div>
      </div>
      ...
      <div class="panel">
        <div class="header">
          ...
          ><span
            ...
            >全部{{ notShowMovieList.length }}部 <span class=" icon-more"></span
          ></span>
        </div>
        <div class="body">
          <div
